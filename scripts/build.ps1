...
Write-Host "testing $env:TEMP\sqlci\"
Write-Host Test-Path "$env:TEMP\sqlci\"
Write-Host "testing $env:TEMP\sqlci\sqlci.exe"
Write-Host Test-Path "$env:TEMP\sqlci\sqlci.exe"
